...
glm(vader_sentiment ~ ideology_score,  family=binomial, data = wm_scores) %>% tidy()

# ideology effect on stance (bert) 
glm(bert_stance ~ ideology_score, family=binomial, data = wm_scores) %>% tidy()

# ideology effect on stance (hand-coded) 
glm(stance ~ ideology_score, family=binomial,data = wm_scores)%>% tidy()
